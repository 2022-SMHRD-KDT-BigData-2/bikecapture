				...
				<tbody>
					...
					<tr>
						<td class="tg-0pky" style="vertical-align: middle;">자동차의 운전자는
							다음 각 호 중 둘 이상의 행위를 연달아 하거나, 하나의 행위를 지속 또는 반복하여 <br>다른 사람에게
							위협 또는 위해를 가하거나 교통상의 위험을 발생하게 하여서는 아니된다. <br>신호 또는 지시위반, 중앙선
							침범, 속도의 위반, 횡단,유턴,후진금지위반 안전거리 미확보, 진로변경 금지 위반 <br>급제동 금지위반
							정당한 사유 없는 소음발생 고속도로에서의 앞지르기 방법 위반
						</td>
					</tr>
					<tr>
						<td class="tg-kaq8" style="vertical-align: middle;">1년 이하의 징역
