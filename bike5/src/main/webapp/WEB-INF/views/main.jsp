			...
			<div id="manual" style="display: none">
				...
				<div class="m">
					<img
						...
						style="float: left; display: flex; justify-content: center; margin-left: 23%; width: 150px; height: 150px;">
					<p class="p-title2">3. 불법구조변경</p>
					<p class="p-content2">
