	...
	<div class="container">
		...
		<div id="grid">
			...
			<div id="manual" style="display: none">
				<p style="font-color: white; font-size: 25px; margin-left: 2%">위반사항</p>
				<div class="m">
					<img
						src="http://www.adinews.co.kr/news/photo/200707/img_1355_0.JPG"
						style="float: left; display: flex; justify-content:center; margin-left: 2%; width: 180px; height: 180px;">
					<p class="p">1.안전모 미착용</p>
					<p>도로교통법 제 50조 (특정 운전자의 준수사항)</p>
					<p>이륜자동차와 원동기장치자전거의 운전자는 행정안전부령으로 정하는</p>
					<p>인명보호 장구를 착용하고 운행하여야하며 동승자에게도 착용하도록 하여야한다
					<p>범칙금 2만원</p>
				</div>
				<div class="m">
sss					<img
						...
						style="float: left; display: flex; justify-content:center; margin-left: 2%; width: 180px; height: 180px;">
					<p class="p">2. 신호위반</p>
					<p>도로교통법 제 5조 (신호 또는 지시에 따를 의무)</p>
					<p>도로를 통행하는 보행자, 차마 또는 노면전차의 운전자는 교통안전시설이 표시하는 신호 또는 지시를 따라야
						한다.</p>
					<p>범칙금 4만원</p>
				</div>
				<div class="m">
					<img
						...
						style="float: left; display: flex; justify-content:center; margin-left: 2%; width: 180px; height: 180px;">
					<p class="p">3. 불법구조변경</p>
					<p>자동차관리법 제 34조 (자동차의 튜닝)</p>
					<p>자동차소유자가 국토교통부령으로 정하는 항목에 대하여 튜닝을 하려는 경우에는 시장·군수·구청장의 승인을
						받아야한다</p>
					<p>1년 이하의 징역 300만원 이하의 벌금</p>
				</div>
				<div class="m">
					<img src="https://s1.dmcdn.net/v/TEPL81XCIr-1hH-Lx/x360"
						style="float: left; display: flex; justify-content:center; margin-left: 2%; width: 180px; height: 180px;">
					<p class="p">4. 난폭운전</p>
					<p>도로교통법 제 46조 3 (난폭운전 금지)</p>
					<p>
						자동차의 운전자는 다음 각 호 중 둘 이상의 행위를 연달아 하거나, 하나의 행위를 지속 또는 반복하여 <br>다른
						사람에게 위협 또는 위해를 가하거나 교통상의 위험을 발생하게 하여서는 아니된다. <br>신호 또는 지시위반,
						중앙선 침범, 속도의 위반, 횡단,유턴,후진금지위반 안전거리 미확보, 진로변경 금지 위반 <br>급제동
						금지위반 정당한 사유 없는 소음발생 고속도로에서의 앞지르기 방법 위반
					</p>
